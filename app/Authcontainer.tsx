        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'black' }}>
            ...
            <View style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: width, flex: 1 }}>
                ...
                <View style={{ width: '80%', display: "flex", gap: 15}}>
                    <TouchableOpacity onPress={() => router.push('/login')} style={{ width: '100%', backgroundColor: "white", height: 50, borderRadius: 7,  alignItems: "center", justifyContent: 'center',display:'flex' }}>
